...
import time
from flask import (
    Blueprint, render_template, jsonify, request, Response, stream_with_context
)
from utils.cv_handler import (
    camera, get_system_stats,
    generate_live_frames, generate_recognition_frames,
...
def camera_open():
    ...
    return jsonify({
        ...
        'message':   'Kamera berhasil dibuka.' if ok else 'Gagal membuka kamera. Pastikan kamera terpasang.'
    })
